...
module.exports = generators.Base.extend({
	...
	writing: function() {
		var outputPath = util.convertToPath(this.name) + ".constant.js";
		
		// Create .js.
		this.fs.copyTpl(
			this.templatePath("../../templates/constant.tpl.js"),
			this.destinationPath(outputPath), {
				resourceURI: this.name,
				moduleName: util.extractModuleName(this.name),
				resourceNameJS: util.resourceNameForJS(this.name) + "Constant"
			}
		);
	}
